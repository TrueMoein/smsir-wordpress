...
class UIAssetsSmsir
{
	...
	public function smsir_load_assets() {
		//styles css
		wp_enqueue_style('regular-fa', ASSETS_CSS . '/regular.min.css', '', '5.0.0');
		wp_enqueue_style('fontawesome5', ASSETS_CSS . '/fontawesome.css', 'regular-fa', '5.0.0');
		wp_enqueue_style('smsir_admin_styles', ASSETS . '/main.css', '', '1.0.0');

		//scrtips js
		wp_enqueue_script('option-page', ASSETS. '/main.js','1.0.0');
	}
}